                    ...
                    <div className="grid grid-cols-1 gap-2">
                      {[
                        ...
                        <div key={key} className="flex items-center text-xs">
                          ...
                          <span
                            className={`transition-colors ${passwordStrength.checks[key] ? "text-green-600 dark:text-green-400" : "text-gray-500 dark:text-gray-400"}`}
                          >
                            {text}
                          </span>
                        </div>
              ...
              <div>
                <div className="flex items-start">
                  <input
                    ...
                    onChange={handleInputChange}
                    className="mt-1 h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded transition-colors"
                  />
                  <label
                    htmlFor="acceptTerms"
