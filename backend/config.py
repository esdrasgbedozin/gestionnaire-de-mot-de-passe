...
class Config:
    ...
    # Configuration Flask
    SECRET_KEY = os.environ.get('JWT_SECRET_KEY') or '***REMOVED***'
    
    # Configuration de la base de données
    SQLALCHEMY_DATABASE_URI = os.environ.get('DATABASE_URL') or \
        'postgresql://admin:***REMOVED***@localhost:5432/password_manager'
    ...
    ENCRYPTION_KEY = os.environ.get('ENCRYPTION_KEY') or '***REMOVED***'
